...
/*
Â * Copyright (C) 2014 Delcio Amarillo
Â *
...
Â * along with this program.Â  If not, see <http://www.gnu.org/licenses/>.
Â */
 ...
 */
	...
	* @param lastRow El índice de la Ãºltima fila en el rango.
	*/
	...
	* 
	* @param firstRow El índice de la primera fila en el rango.
	* @param lastRow El Ã­ndice de la Ãºltima fila en el rango.
	*/
	...
	* 
	* @param row El Ã­ndice de la fila a la que pertenece la celda.
	* @param column El Ã­ndice de la columna a la que pertenece la celda.
	*/
	...
	* 
	* @param domainObject El objeto de dominio.
	* @param rowIndex El nÃºmero de fila.
	*/
	...
	*/
	...
	/**
	* Elimina una fila del table model según índice.
    * Nota: NO remueve todas las ocurrencias del objeto 
    * de dominio asociado al número de fila, solo la indicada 
    * por el parámetro {@code rowIndex}
	* @param rowIndex El nÃºmero de fila a eliminar.
	*/
	...
	* @throws IllegalArgumentException Si {@code firstRow < 0} Ã³ {@code lastRow < 0} Ã³ {@code firstRow > lastRow}.
	*/
	...
	* Devuelve un objeto de dominio basado en un número de fila.
     * @param rowIndex El nÃºmero de la fila.
	...
	* @param lastRow La Ãºltima fila del rango (inclusive).
